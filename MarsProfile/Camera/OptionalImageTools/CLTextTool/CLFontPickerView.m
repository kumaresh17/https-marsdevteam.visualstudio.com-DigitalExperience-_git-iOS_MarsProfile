...
+ (NSArray*)allFontList
{
    ...
    for(NSString *familyName in [UIFont familyNames]){
        NSLog(@"TextFont ---- %@",familyName);
        for(NSString *fontName in [UIFont fontNamesForFamilyName:familyName]){
            if([fontName rangeOfString:@"Mars"].location != NSNotFound || [fontName rangeOfString:@"Luna"].location != NSNotFound){
...
+ (UIFont*)defaultFont
{
    return [UIFont fontWithName:@"Marsfont"size:kCLFontPickerViewConstantFontSize];
}
