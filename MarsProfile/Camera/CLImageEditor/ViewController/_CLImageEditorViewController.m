...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [self.view setBackgroundColor:[UIColor colorWithRed:36.0/256.0 green:192.0/256.0 blue:242.0/256.0 alpha:1.0]];
...
+ (NSArray*)subtools
{
    return [CLImageToolInfo toolsWithToolClass:[MISImageToolbase class]];
}
